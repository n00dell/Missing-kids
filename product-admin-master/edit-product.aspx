<%@ Page Title="" Language="C#" MasterPageFile="~/product-admin-master/Dash.Master" AutoEventWireup="true" CodeBehind="edit-product.aspx.cs" Inherits="MissingKids.product_admin_master.edit_product" %>
	  ...
	  <div class="row">
		<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
		  <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
			<div class="row">
			  <div class="col-12">
				<h2 class="tm-block-title d-inline-block">Edit Entry</h2>
			  </div>
			</div>
			<div class="row tm-edit-product-row">
			  <div class="col-xl-6 col-lg-6 col-md-12">
				<div class="tm-edit-product-form">
				  ...
				  <div class="form-group mb-3">
					  ...
					  <asp:DropDownList ID="dropdownGender" CssClass="custom-select tm-select-accounts" SkinID="category" runat="server">
			  ...
			  <div class="col-12">
				  <asp:Button ID="btnUpdate" CssClass="btn btn-primary btn-block text-uppercase" runat="server" OnClick="btnUpdate_OnClick" Text="Update Entry" />
			  </div>
			</div>
			</div>
		  </div>
